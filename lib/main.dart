      ...
      child: IntroductionScreen(
        ...
        pages: [
          ...
          PageViewModel(
            ...
            body: c.language.string == 'VN'
                ? 'Hàng trăm chủ đề, bao phủ nhiều mặt, nhiều lĩnh vực. '
          ...
          PageViewModel(
            ...
            body: c.language.string == 'VN'
                ? 'Học dễ dàng với những trò chơi đơn giản, hiệu quả '
          ...
          PageViewModel(
            ...
            body: c.language.string == 'VN'
                ? 'Dịch Anh-Việt và ngược lại, bất cứ cụm từ nào.'
...
class ProcessWidget extends StatefulWidget {
  ...
  const ProcessWidget({Key? key, required this.meanLength}) : super(key: key);
                ...
                children: [
                  ...
                  GetBuilder<Controller>(
                    builder: (_) => Container(
                      ...
                      child: Column(
                        children: mean[listIndex[nowIndex]]
                            .map<Widget>(
                              (subMean) => Container(
                                margin: const EdgeInsets.fromLTRB(0, 0, 0, 5),
